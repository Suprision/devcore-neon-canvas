...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      gradient: "from-neon-magenta/20 to-neon-green/20"
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black mb-6">
            <span className="text-neon-magenta">OUR</span>{" "}
            <span className="text-foreground">FEATURED</span>{" "}
            <span className="text-neon-cyan">PROJECTS</span>
          </h2>
          <div className="h-1 w-24 bg-neon-magenta mx-auto mb-8 neon-glow"></div>
        ...
        <div className="space-y-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group relative p-8 rounded-xl gradient-card border border-muted hover:border-neon-cyan transition-all duration-500 hover:scale-[1.02]"
            >
              ...
              <div className="relative z-10 grid lg:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-black mb-4 text-foreground group-hover:text-neon-cyan transition-colors duration-300">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex gap-4">
                    <button className="flex items-center gap-2 px-4 py-2 bg-transparent border border-neon-cyan text-neon-cyan rounded-lg hover:bg-neon-cyan hover:text-background transition-all duration-300 neon-glow hover:neon-glow-strong">
                ...
                <div className="relative">
                  <div className="aspect-video bg-gradient-to-br from-muted/50 to-background/50 rounded-lg border-2 border-dashed border-muted-foreground/30 flex items-center justify-center group-hover:border-neon-cyan/50 transition-colors duration-300">
                    <div className="text-center">
                      <Play className="w-16 h-16 text-muted-foreground group-hover:text-neon-cyan transition-colors duration-300 mx-auto mb-4" />
                  ...
                  <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-neon-purple rounded-full animate-pulse delay-300"></div>
                </div>
              </div>
            </div>
          ))}
